...
class Ui_adminRegistration(object):
    def setupUi(self, adminRegistration):
        ...
        adminRegistration.resize(1218, 820)
        adminRegistration.setStyleSheet("background-color: #FCFEFE;")
        adminRegistration.setAnimated(True)
        adminRegistration.setDocumentMode(False)
...
"")
    ...
    def retranslateUi(self, adminRegistration):
        ...
        adminRegistration.setWindowTitle(_translate("adminRegistration", "adminRegistration"))
